...
describe AllergiesController do
  ...
  def mock_allergy(stubs={})
    @mock_allergy ||= mock_model(Allergy, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all allergies as @allergies" do
      Allergy.stub(:all) { [mock_allergy] }
      get :index
      assigns(:allergies).should eq([mock_allergy])
    end
  end

  describe "GET show" do
    it "assigns the requested allergy as @allergy" do
      Allergy.stub(:find).with("37") { mock_allergy }
      get :show, :id => "37"
      assigns(:allergy).should be(mock_allergy)
    end
  end

  describe "GET new" do
    it "assigns a new allergy as @allergy" do
      Allergy.stub(:new) { mock_allergy }
      get :new
      assigns(:allergy).should be(mock_allergy)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created allergy as @allergy" do
        Allergy.stub(:new).with({'these' => 'params'}) { mock_allergy(:save => true) }
        post :create, :allergy => {'these' => 'params'}
        assigns(:allergy).should be(mock_allergy)
      end

      it "redirects to the created allergy" do
        Allergy.stub(:new) { mock_allergy(:save => true) }
        post :create, :allergy => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved allergy as @allergy" do
        Allergy.stub(:new).with({'these' => 'params'}) { mock_allergy(:save => false) }
        post :create, :allergy => {'these' => 'params'}
        assigns(:allergy).should be(mock_allergy)
      end

      it "re-renders the 'new' template" do
        Allergy.stub(:new) { mock_allergy(:save => false) }
        post :create, :allergy => {}
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested allergy as @allergy" do
        Allergy.stub(:find) { mock_allergy(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:allergy).should be(mock_allergy)
      end
    ...
    describe "with invalid params" do
      it "assigns the allergy as @allergy" do
        Allergy.stub(:find) { mock_allergy(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:allergy).should be(mock_allergy)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the allergies list" do
      Allergy.stub(:find) { mock_allergy }
      delete :destroy, :id => "1"
